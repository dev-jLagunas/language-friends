...
<template>
  ...
  >
    ...
    <!-- Intro -->
    <article class="about-card-container" data-step="1">
      <header class="bg-moko-blue-soft rounded-2xl p-8">
        <p
    ...
    <!-- Philosophy -->
    <article class="about-card-container" data-step="2">
      ...
      <header
        class="bg-niko-purple-soft rounded-2xl md:rounded-3xl p-6 md:p-10"
      >
        <p
          class="section-big-numbers text-dark-primary/50 dark:text-light-primary/50 absolute -top-10 right-0 md:-top-16"
        >
    ...
    <!-- Learning -->
    <article class="about-card-container" data-step="3">
      <header
        class="bg-okja-yellow-soft rounded-2xl md:rounded-3xl p-6 md:p-10"
      >
        <p
          class="section-big-numbers text-dark-primary/50 dark:text-light-primary/50 absolute -top-10 right-0 md:-top-16"
        >
    ...
    <!-- Characters -->
    <article class="about-card-container" data-step="4">
      <figure class="order-last md:order-first">
        <img
      ...
      <header class="bg-moko-blue-soft rounded-2xl md:rounded-3xl p-6 md:p-10">
        <p
          class="section-big-numbers text-dark-primary/50 dark:text-light-primary/50 absolute -top-10 right-0 md:-top-16"
        >
          4.
    ...
    <!-- Parents -->
    <article class="about-card-container" data-step="5">
      <header
        class="bg-niko-purple-soft rounded-2xl md:rounded-3xl p-6 md:p-10"
      >
        <p
