...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2496cd5a-74d6-464d-b152-c84dfbc0bd77",
...
const localeLoaders = {
  ja: [
    {
      key: "locale_ja_46json_7e4121ea",
      load: () => import('./ja.mjs' /* webpackChunkName: "locale_ja_46json_7e4121ea" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_790b4981",
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_790b4981" */),
      cache: true
    }
  ]
};
...
const _pr1VtSgCYSYXBXCBQ_lV0gbGWOtnBvdA4yFuY1O1Ubc = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/yoz5RyeQ") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const _V8XOoBYKLmRlXPsSn13n_wmPoyTm5cdoDZ75kpwpZ0 = (function(nitro) {
...
const plugins = [
  _pr1VtSgCYSYXBXCBQ_lV0gbGWOtnBvdA4yFuY1O1Ubc,
_V8XOoBYKLmRlXPsSn13n_wmPoyTm5cdoDZ75kpwpZ0
];
...
const _QOkPKF = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _6oWoCy = _messagesHandlerCached;

const _lazy_gHKVlm = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_gHKVlm, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _QOkPKF, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _6oWoCy, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_gHKVlm, lazy: true, middleware: false, method: undefined }
];
